...
var Dropdown = index_vue_2.default;
...
___scope___.file("src/components/sidebar.vue", function(exports, require, module, __filename, __dirname){
...
var _v = function (exports) {
    ...
    var Sidebars = function (_super) {
        ...
        Sidebars = __decorate([vue_property_decorator_1.Component], Sidebars);
        return Sidebars;
    }(Vue);
    ...
    return _c('div', [
        _c('s-table', {
            ...
            _c('s-row-edit-column', {
                on: {
                    'edit': function (row, state) {
                        return _vm.copy(row, state);
                    },
                    'cancel': function (row, state) {
